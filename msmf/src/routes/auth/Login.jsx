...
const Login = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-secondary p-6 rounded-3xl flex flex-col gap-4 shadow-gray-950 text-center w-lg">
            ...
            <div className="flex flex-col gap-2">
                <label>Password:
                    <input className="rounded-2xl outline outline-input bg-third p-2.5 w-full transition-shadow focus:outline-input-focus focus:shadow-input-auth focus:shadow-input-shadow" type="password" placeholder="Password" name="password" required value={password} onChange={(e) => setPassword(e.target.value)} />
                </label>
            </div>
